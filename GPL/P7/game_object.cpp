...
void Game_object::copy_all_attributes(const Game_object& other)
{
    ...
    m_proximity = other.m_proximity;
    m_drawing_order = other.m_drawing_order;
    m_user_int = other.m_user_int;
    m_user_double = other.m_user_double;
    m_user_string = other.m_user_string;
    m_user_int2 = other.m_user_int2;
    m_user_double2 = other.m_user_double2;
    m_user_string2 = other.m_user_string2;
    m_user_int3 = other.m_user_int3;
    m_user_double3 = other.m_user_double3;
    m_user_string3 = other.m_user_string3;
    m_user_int4 = other.m_user_int4;
    m_user_double4 = other.m_user_double4;
    m_user_string4 = other.m_user_string4;
    m_user_int5 = other.m_user_int5;
    m_user_double5 = other.m_user_double5;
    m_user_string5 = other.m_user_string5;

    // Mark display list as dirty since we changed attributes
    m_display_list_dirty = true;
}
