...
class Game_object
{
  public:
    ...
    // Copies all attributes from another game object
    void copy_all_attributes(const Game_object& other);

    void debug_print() const {
        std::cout << "\nGame_object at " << this << ":" << std::endl
                  << "  m_x = " << m_x << std::endl
                  << "  m_y = " << m_y << std::endl
                  << "  m_w = " << m_w << std::endl
                  << "  m_h = " << m_h << std::endl
                  << "  m_visible = " << m_visible << std::endl
                  << "  m_object_type = " << gpl_type_to_string(m_object_type) << std::endl;
    }

    void set_animation_block(Animation_block* block) { m_animation_block = block; }
    Animation_block* get_animation_block() const { return m_animation_block; }
